...
data type LampControl from pidcontrol.idl.
This example builds two applications, named pidcontrol_publisher and
pidcontrol_subscriber.
...
> make -f makefile_pidcontrol_x64Linux4gcc7.3.0
This command will build a release executable.
 
To build a debug version instead:
> make -f makefile_pidcontrol_x64Linux4gcc7.3.0 DEBUG=1

To Modify the Data:
===================
To modify the data being sent, edit the pidcontrol_publisher.cxx
file where it says:
...
Run C:\Program Files\rti_connext_dds-7.3.0\bin\../resource/scripts/rtisetenv_x64Linux4gcc7.3.0.bash
...
> objs/x64Linux4gcc7.3.0/pidcontrol_publisher -d <domain_id> -s <sample_count>
> objs/x64Linux4gcc7.3.0/pidcontrol_subscriber -d <domain_id> -s <sample_count>
